...
It\'s a slice-of-life romantic comedy about couples who aren\'t really couples!''',
    ...
    Book(
      ...
      price: 175.0,
      description: 'In the Great Orient, lies a continent called Rodenius. One day, an unidentified flying object arrived at Qua-Toyne Principality s airspace.That UFO defied the Principality s common sense,...',
      size: 'bunko',
      inStock: 5,
      maxBuy: 2,
      dateSell: DateTime.parse('2025-04-11'),
